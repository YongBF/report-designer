...
5. **代码质量提升时** ⭐ 新增
   ...
   - 使用 `@refactor` 进行代码重构
   - 使用 `@docs` 生成/更新文档
   - 参考已安装的 Claude Skills

6. **使用 Pinia Store 时** ⭐ 更新
   - 参考"Pinia 状态管理最佳实践"
   - 注意自动解包特性
   - 不要使用 `.value` 访问状态
...
```
"请参考 .claude/PROJECT_CONTEXT.md 文档，了解 Report Designer 项目的上下文、路由系统、组件命名功能、统一属性面板、Claude Skills 集成和已知问题。"
```

这样可以大幅减少错误重犯，提高开发效率！🎯

**最新功能** (v2.6 - 2026-01-20):
- 🧹 代码质量提升 - 移除所有 console.log/error/warn/info/debug 语句
- 🤖 Claude Skills - 安装 5 个 AI 开发技能（审查、测试、文档、解释、重构）
- ⚡ Slash Commands - 6 个快捷命令（commit, tdd, docs, review, explain, refactor）
- 📚 文档完善 - PROJECT_CONTEXT.md 新增 Skills 集成章节

**历史功能** (v2.4 - 2026-01-17):
