<template>
  <el-form label-width="100px" size="small">
    ...
    <el-form-item label="内半径">
      <el-input v-model="localComponent.radius[0]" placeholder="如: 0%" @change="handleChange" />
    </el-form-item>

    <el-form-item label="外半径">
      <el-input v-model="localComponent.radius[1]" placeholder="如: 70%" @change="handleChange" />
    </el-form-item>

    <el-form-item label="圆心X">
      <el-input v-model="localComponent.center[0]" placeholder="如: 50%" @change="handleChange" />
    </el-form-item>

    <el-form-item label="圆心Y">
      <el-input v-model="localComponent.center[1]" placeholder="如: 50%" @change="handleChange" />
    </el-form-item>
    ...
    <el-form-item label="最小角度">
      <el-input-number
        v-model="localComponent.minAngle"
        :min="0"
        :max="90"
        @change="handleChange"
      />
...
watch(
  ...
  (newComponent) => {
    ...
    localComponent.roseType = newComponent.roseType;
    localComponent.emphasisScale = newComponent.emphasisScale;
    localComponent.minAngle = newComponent.minAngle;
