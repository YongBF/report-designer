...
// 监听配置变化 - 使用浅层监听避免性能问题
watch(
  () => [props.component.config, props.component.xAxis, props.component.yAxis, props.component.series, props.component.smooth, props.component.step, props.component.showSymbol, props.component.symbolSize, props.component.lineStyleWidth, props.component.lineStyleType, props.component.areaStyle, props.component.dataSource],
  () => {
    nextTick(() => {
      updateChartOptions()
    })
