...
const { selectedIds, canUndo, canRedo, updateComponent } = designerStore;
...
// ============ 工具栏方法 ============
const { handleNew, handleUndo, handleRedo, handleSave } = toolbar;
...
function handleFormItemButtonClick(component: any, item: any) {
  ...
  linkageManager.triggerLinkage(
    ...
    formData,
    () => designerStore.currentDesign.components
  );
